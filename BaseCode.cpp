...
void init(int width=240, int height=240){
...
class Windows_Index: public WindowsType{
    public:
        Windows_Index(){
            int x_mid = 120;
            texts.push_back(Text(x_mid, 50, _T("Hello world!"), 24, BLACK, _T("宋体"),make_pair(0,0)));
            buttons.push_back(Button(x_mid,150,200,50,Text(_T("Leo Anderson"), 12, WHITE, _T("宋体"),make_pair(0,0)), GREEN, WHITE, make_pair(0,0), make_pair(0,0)));
            }
};
